<div class="row">
    <div class="col-md-6 col-sm-6 col-xs-12 form-search-panel">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo lang('search') ?><small>Barang</small></h2>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 form-action-panel">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo lang('action') ?><small>Barang</small></h2>
                <div class="clearfix"></div>
            </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 table-data-panel">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo lang('list') ?><small>Barang</small></h2>
...
$(document).ready(function() {
    ...
    // Load Form Add
    let form_add = sendAjax('<?php echo base_url('app/create_barang') ?>');
    ...
    $("form[name='search']").on('submit', function(e) {
        e.preventDefault();
        let uri = '<?php echo base_url('app/index_barang') ?>';
